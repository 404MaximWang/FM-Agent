...
3. Read any domain context files mentioned in the batch prompt (e.g., `engine_overview.txt`, `types.txt`, `module_types/*.txt`, and user-provided Markdown files under `user_knowledge/`)
